...
class CustomerModel extends BaseModel
{
    ...
    /**
     * Ambil semua pelanggan (Join users & customers) beserta berkas identitas
     */
    public function getAllWithUsers(): array
    {
        $sql = "SELECT c.id as customer_id, c.nik, c.driver_license_number, c.id_card_image, c.driver_license_image,
    ...
    /**
     * Ambil detail 1 pelanggan beserta berkas identitas
     */
